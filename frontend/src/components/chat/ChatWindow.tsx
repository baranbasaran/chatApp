...
const MessageList = React.memo(
  ({ messages, loggedInUserId, messagesEndRef }: MessageListProps) => {
...
const ChatHeader = React.memo(
  ({ otherParticipant, isTyping, loggedInUser }: ChatHeaderProps) => {
    return (
...
const ChatWindowContent = React.memo(() => {
  ...
  const { activeChat, messages, typingStatus } = chatState;
  ...
  }, [activeChat?._id, sendTypingStatus]);
  ...
  const handleSendMessage = useCallback(
    ...
    [activeChat?._id, sendMessage, sendTypingStatus]
  );
  ...
  const isTyping = typingStatus[activeChat._id] || false;
